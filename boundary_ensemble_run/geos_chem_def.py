...
en_path ='/scratch/local/shzhu/EN_BOND/TEST/boundary_ensemble_run/'
run_path='/scratch/local/shzhu/EN_BOND/TEST/merra2_4x5_tagCH4/'
temp_path = en_path+ 'temp/'
met_path = '/scratch/local/shzhu/GC_DATA/ctm/GEOS_4x5/MERRA2' #HEMCO_Config.rc
...
cfg_pb_file='./ens_ch4_bd_cfg.2016'
...
##c selected run
select_runs=list(range(0, 15)) #26
#select_sous=
